...
| [0013](0013-dp-viterbi-traversal.md) | DP/Viterbi traversal over the phrase hypergraph | Accepted (amended by ADR-0030) |
...
| [0034](0034-experiment-axes-and-identities.md) | Run generator experiments as variant × information regime, with separate identities and comparable-only metrics | Proposed |
