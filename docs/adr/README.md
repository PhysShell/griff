...
| [0034](0034-experiment-axes-and-identities.md) | Run generator experiments as variant × information regime, with separate identities and comparable-only metrics | Accepted |
