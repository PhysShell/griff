...
//! `structure`) is run against every committed fixture and its stdout/stderr
//! pinned to a golden snapshot. These tests describe what the CLI *does* today;
//! they must not be "fixed" by changing expectations without a deliberate
//! re-bless.
//!
