...
fn register_fields(pitches: &[u8], in_lo: u8, in_hi: u8, palette: &[u8]) -> String {
    if pitches.is_empty() {
        return "\"output_span\":0,\"exact_high_share\":0.0,\"mode_pitch_share\":0.0,\"mean_abs_interval\":0.0,\"max_abs_interval\":0,\"largest_upward_interval\":0,\"largest_downward_interval\":0,\"octave_leap_share\":0.0,\"at_least_octave_share\":0.0,\"exact_octave_share\":0.0,\"over_octave_share\":0.0,\"alternation_rate\":0.0,\"pitch_stddev\":0.0,\"in_class_rate\":0.0".to_string();
    }
    ...
    let oct_leap_share = absint.iter().filter(|&&i| i >= 12).count() as f64 / idenom; // >=12
    ...
    let pstd = (pitches
        ...
        .sqrt();
    format!(
        "\"output_span\":{},\"exact_high_share\":{exact_high:.3},\"mode_pitch_share\":{mode_share:.3},\"mean_abs_interval\":{mean_int:.2},\"max_abs_interval\":{max_int},\"largest_upward_interval\":{up},\"largest_downward_interval\":{down},\"octave_leap_share\":{oct_leap_share:.3},\"at_least_octave_share\":{oct_leap_share:.3},\"exact_octave_share\":{exact_octave:.3},\"over_octave_share\":{over_octave:.3},\"alternation_rate\":{alternation:.3},\"pitch_stddev\":{pstd:.2},\"in_class_rate\":{in_class:.3}",
